...
import gambar from '../../assets/image PHP.png'
import icon from '../../icons/icon_vidio.png'

const KomentarPadaPHP = () => {
...
<>
    <div className='w-full px-4'>
        ...
        <div className='container mx-auto px-4'>
            <h1 className='text-3xl font-bold text-center mt-10'>Komentar Pada PHP</h1>
            ...
            <div className='max-w-[1240] grid md:grid-cols-3 mt-10 '>
              ...
              <div className="bg-[#F8F9FD] rounded-2xl shadow-md p-6 md:col-span-1" >
                   ...
                   <div style={{ maxHeight: '330px', overflowY: 'auto' }}>
                    ...
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/KomentarPadaPHP')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>Komentar Pada PHP</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/VariabelPadaPHP')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>Variabel Pada PHP</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/TipeDataPHP')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>Tipe Data PHP</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/OperatorPHP')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>Operator PHP</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/IfElse')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>If Else</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/Switch')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>Switch</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/WhileAndDoWhile')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
                        <span className='mt-2 '>While and Do While</span>
                    </button>
                    <button className="bg-[#CDDEFF] text-black py-2 px-4 rounded-3xl  flex w-full mt-4" onClick={() => navigateTo('/ForAndForeach')}>
                        <img src={icon} alt="" className='w-[40px] mr-3' />
...
export default KomentarPadaPHP